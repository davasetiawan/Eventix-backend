...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'google-id-token-or-email' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'budi@gmail.com', required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], GoogleLoginDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: user_entity_1.UserRole, default: user_entity_1.UserRole.USER, required: false }),
