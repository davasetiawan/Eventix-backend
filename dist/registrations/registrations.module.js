...
exports.RegistrationsModule = RegistrationsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([registration_entity_1.Registration, event_entity_1.Event, ticket_tier_entity_1.TicketTier, payment_method_entity_1.PaymentMethod]),
